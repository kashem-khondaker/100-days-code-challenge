...
from users.views import sign_up,sign_in,Admin_dashboard,assigned_role , user_logout,activate_user , Create_Group , ChangePassword ,group_list,CustomLoginView,ProfileView
